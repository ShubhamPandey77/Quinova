...
// Values
export const values = [
  { icon: null, title: "Mission-Driven", desc: "We're committed to delivering excellence in every project", color: "from-emerald-500 to-teal-600" },
  { icon: null, title: "Client-Focused", desc: "Your success is our success, always putting clients first", color: "from-green-500 to-emerald-600" },
  { icon: null, title: "Innovation", desc: "Staying ahead with cutting-edge technologies and methods", color: "from-teal-500 to-cyan-600" },
  { icon: null, title: "Reliability", desc: "Consistent quality and on-time delivery you can count on", color: "from-lime-500 to-green-600" }
];
