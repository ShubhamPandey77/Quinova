                    ...
                    <div className="max-w-7xl mx-auto relative">
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div className="text-left">
                                <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black leading-none mb-8 tracking-tighter uppercase relative inline-block font-inter">
                                    {words.map((word, i) => {
                                ...
                                ></Motion.div>
                                <p className="text-lg md:text-xl text-slate-600 max-w-2xl mb-12 leading-relaxed font-medium font-inter">
