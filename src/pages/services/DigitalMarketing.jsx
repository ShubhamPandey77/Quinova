...
import { TrendingUp, CheckCircle, ArrowRight, X, Mail, Megaphone, Target, BarChart, ChevronLeft } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div className="space-y-6 animate-fadeIn">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Comprehensive digital marketing strategies that combine paid ads, SEO, and funnels to scale your business predictably.
                </p>
                <button
              ...
              <div className="hidden md:flex justify-center animate-slideUp">
                <div className="w-full h-96 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl flex items-center justify-center border border-gray-300 shadow-xl hover:shadow-2xl transition-all duration-300">
                  <Megaphone className="w-40 h-40 text-gray-500 hover:scale-110 transition-transform duration-300" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-20 py-16 animate-slideUp">
              <div className="space-y-6">
                <h3 className="text-3xl font-bold">✨ Key Strategies</h3>
              ...
              <div className="space-y-6 animate-slideUp">
                <h3 className="text-3xl font-bold">📈 Marketing Benefits</h3>
                <ul className="space-y-4">
            ...
            <div className="bg-gray-100 rounded-2xl p-12 mb-20 border border-gray-200 shadow-lg animate-slideUp">
              <h3 className="text-3xl font-bold mb-10">🛠️ Our Marketing Suite</h3>
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li>→ High-intent Landing Pages</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black text-white rounded-2xl p-12 text-center shadow-2xl animate-slideUp">
              <h3 className="text-3xl font-bold mb-8">Ready to Scale?</h3>
              <button
                onClick={() => setShowContactForm(true)}
          ...
          <div className="bg-white border border-gray-300 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto relative">
            ...
            <div className="p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <textarea placeholder="Tell us about your marketing goals..." value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} rows="4" className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:border-black transition-colors"></textarea>
