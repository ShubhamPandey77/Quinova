...
import { FileText, CheckCircle, ArrowRight, X, Mail, BookOpen, PenTool, ChevronLeft } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div className="space-y-6 animate-fadeIn">
                <div className="inline-block bg-gray-200 text-gray-800 px-4 py-2 rounded-full text-sm font-semibold border border-gray-300">
                  ✍️ Premium Content Writing
                </div>
                <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold leading-tight text-gray-900">
                  Persuasive Content Strategy
                </h1>
                <p className="text-xl text-gray-600 leading-relaxed">
                  High-quality, SEO-optimized content that informs your audience and drives conversions through persuasive storytelling.
                </p>
                <button
              ...
              <div className="hidden md:flex justify-center animate-slideUp">
                <div className="w-full h-96 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl flex items-center justify-center border border-gray-300 shadow-xl hover:shadow-2xl transition-all duration-300">
                  <FileText className="w-40 h-40 text-gray-500 hover:scale-110 transition-transform duration-300" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-20 py-16 animate-slideUp">
              <div className="space-y-6">
                <h3 className="text-3xl font-bold">✨ Writing Expertise</h3>
            ...
            <div className="bg-black text-white rounded-2xl p-12 text-center shadow-2xl animate-slideUp">
              <h3 className="text-3xl font-bold mb-8">Need Quality Content?</h3>
              <button
                onClick={() => setShowContactForm(true)}
      ...
      {showContactForm && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="bg-white border border-gray-300 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto relative">
            ...
            <div className="p-10">
              <h2 className="text-3xl font-bold mb-2">Start Your Content</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <textarea placeholder="Tell us about your content needs..." value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} rows="4" className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:border-black transition-colors"></textarea>
