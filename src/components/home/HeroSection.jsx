      ...
      <div className="max-w-7xl relative z-10 mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <h1 className="text-3xl md:text-6xl font-black leading-none mb-8 tracking-tight uppercase relative inline-block font-inter">
              {words.map((word, i) => {
          ...
          <div className="relative h-[400px] md:h-[550px] w-full flex items-start justify-end mt-2 md:-mt-48">
              ...
              {[
                ...
                return (
                  <Motion.div 
                    ...
                    className={`absolute -translate-x-1/2 -translate-y-1/2 ${positions[index]} bg-white p-4 md:p-5 rounded-2xl border border-slate-200 shadow-2xl transition-all duration-500 flex items-center gap-3 md:gap-4 group hover:scale-105 hover:z-20 hover:border-slate-900 w-64 md:w-72 cursor-pointer`}
                  >
                    ...
                    <div>
                      <span className="font-black text-base md:text-xl text-slate-900 uppercase tracking-normal leading-none block mb-1">{item.title}</span>
