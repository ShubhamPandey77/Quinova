...
import { Menu, X, Mail, ArrowRight, User, Phone, DollarSign, MessageSquare, Briefcase, ChevronDown, Check, Globe, Smartphone, Video, Palette, PenTool, BarChart, Loader2, Bot } from "lucide-react";
    ...
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2.5 rounded-xl font-medium bg-blue-50 text-black hover:bg-blue-100 transition-all duration-300 hover:scale-105 active:scale-95"
              >
                <style>{`
                  @keyframes dotBounce {
                  ...
                  .navbar-dot:nth-child(1) { animation-delay: 0s; }
                  .navbar-dot:nth-child(2) { animation-delay: 0.2s; }
                  .navbar-dot:nth-child(3) { animation-delay: 0.4s; }
                `}</style>
                <Bot className="w-4 h-4" />
                <span className="text-xs">Quinova Talks</span>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-4 pb-4 space-y-2 border-t border-slate-200 pt-4">
              ...
              <button
                ...
                className="w-full flex items-center gap-1.5 justify-center px-3 py-2.5 rounded-lg font-medium bg-blue-50 text-black hover:bg-blue-100 transition-colors"
              >
                <Bot className="w-4 h-4" />
                <span className="text-xs">Quinova Talks</span>
                <span className="flex items-center gap-0.5">
      ...
      {showChatbot && (
        ...
        >
          ...
          <div 
            className="bg-white rounded-2xl shadow-2xl w-full max-w-md h-[600px] relative transform transition-all duration-300 scale-100 flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 rounded-t-2xl flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
                  <Bot className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 className="text-white font-semibold">Quinova Talks</h3>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              <div className="flex justify-start">
                <div className="bg-slate-100 text-black px-4 py-2 rounded-lg max-w-xs">
                  <p className="text-xs">Hi there! 👋 I'm Quinova Talks, your AI assistant. How can I help you today?</p>
                </div>
              </div>
              <div className="flex justify-start">
                <div className="bg-slate-100 text-black px-4 py-3 rounded-lg max-w-xs flex items-center gap-1">
                  <style>{`
                    @keyframes bounce {
                      0%, 60%, 100% { opacity: 0.3; transform: translateY(0); }
            ...
            <div className="border-t border-slate-200 p-4 space-y-3">
              <div className="grid grid-cols-1 gap-2">
                <button className="text-left px-3 py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-lg text-sm font-medium transition-colors">
              ...
              <input 
                ...
                className="w-full px-3 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm"
              />
            </div>
          </div>
        </div>
