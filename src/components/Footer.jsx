...
function Footer({ navigate = () => {} }) {
  ...
  const socialLinks = [
    { Icon: Facebook, link: '#', color: 'hover:bg-gray-700' },
    { Icon: Instagram, link: 'https://www.instagram.com/quinova.official/', color: 'hover:bg-pink-600' },
    { Icon: Linkedin, link: '#', color: 'hover:bg-gray-700' },
  ];
    ...
    <>
      <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-0 w-96 h-96 bg-gray-800 rounded-full blur-3xl animate-blob"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-indigo-500 rounded-full blur-3xl animate-blob-delayed"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-2 animate-fade-in-up">
              <div className="flex items-center gap-3 mb-4 group">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl blur-lg opacity-50 group-hover:opacity-100 transition-opacity animate-pulse-glow"></div>
                  <img 
                ...
                <div>
                  <div className="text-2xl font-bold bg-gradient-to-r from-gray-700 to-gray-600 bg-clip-text text-transparent animate-gradient-x">
                    Quinova
                  </div>
                  <div className="text-gray-400 text-sm font-semibold">Digital Excellence</div>
                </div>
              </div>
              <p className="text-slate-400 mb-6 max-w-md leading-relaxed animation-delay-100">
              ...
              <div className="flex gap-4 animation-delay-200">
            ...
            <div className="animate-fade-in-up animation-delay-300">
              <h3 className="font-bold text-lg mb-4 text-gray-400 flex items-center gap-2">
          ...
          {/* Bottom Bar */}
          <div className="border-t border-slate-700/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 animation-delay-500">
            <div className="text-slate-400 text-sm">
              © 2024 Quinova. All rights reserved. Built with{' '}
              <Heart className="inline w-4 h-4 text-blue-500 animate-pulse" />{' '}
              and excellence.
            </div>
            <div className="flex gap-6 text-sm">
              {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map((policy, index) => (
                <button 
                  key={index}
                  className="text-slate-400 hover:text-gray-400 transition-colors relative group"
                >
                  {policy}
          ...
          <div className="modal-container animate-modal-bounce">
            ...
            <div className="relative p-8 md:p-10">
              <div className="mb-8">
                ...
                <p className="text-slate-600 animation-delay-100">Fill out the form below and we'll get back to you within 24 hours</p>
              </div>
