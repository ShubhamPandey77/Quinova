  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/services/website-development" element={<PageTransition><WebsiteDevelopment /></PageTransition>} />
        <Route path="/services/social-media-management" element={<PageTransition><SocialMediaManagement /></PageTransition>} />
        <Route path="/services/video-editing" element={<PageTransition><VideoEditing /></PageTransition>} />
        <Route path="/services/graphic-design" element={<PageTransition><GraphicDesign /></PageTransition>} />
        <Route path="/services/content-writing" element={<PageTransition><ContentWriting /></PageTransition>} />
        <Route path="/services/digital-marketing" element={<PageTransition><DigitalMarketing /></PageTransition>} />
        <Route path="/services/app-development" element={<PageTransition><AppDevelopment /></PageTransition>} />
        <Route path="/services/academic-projects" element={<PageTransition><AcademicProjects /></PageTransition>} />
